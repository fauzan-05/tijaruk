...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={introRef}
        className="absolute left-6 top-10 z-20 flex max-w-[300px] flex-col items-start text-left sm:left-[28px] sm:top-12 sm:max-w-[360px] lg:left-[60px] lg:top-14 lg:max-w-[430px]"
      >
