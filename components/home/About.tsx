      ...
      <div className="mx-auto grid max-w-[1440px] gap-8 px-4 sm:px-6 lg:h-screen lg:grid-cols-[minmax(320px,0.88fr)_minmax(0,1fr)] lg:items-center lg:gap-8 lg:px-10">
        ...
        <div ref={contentRef} className="flex w-full max-w-[620px] flex-col items-start justify-center lg:justify-self-start">
          ...
          <div className="mt-5 w-full font-['Poppins',sans-serif] text-[14px] leading-7 text-[#696969] sm:text-[15px] sm:leading-8">
            <p>
              Tijaruk connects businesses in Saudi Arabia to global markets <br /> through structured sourcing and reliable trade execution. We <br /> work closely with suppliers and partners to ensure operations <br /> remain clear and controlled. <br />
We focus on enabling consistent market access and long-term <br />expansion, building a dependable link between Saudi Arabia and <br />international trade.
            </p>
          </div>
          <a
